...
市区町村単位で児童虐待の疑いがある事例を投稿し、同様の疑念を抱く声を集める。そうすることで通報への後押しとなり、子どもの保護につながるアプリケーションとなる。本アプリケーションは「東京都台東区」をカバーする。プライバシーの保護には細心の注意を払い、発生場所や日時のみの投稿とし、実名投稿は禁止とする。公共性と匿名性のバランスについては東京都の児童相談所と相談済みである。
